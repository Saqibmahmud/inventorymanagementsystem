...
class ProductsController extends Controller
{
    public function index(){
        $allProducts=Products::with('product_categories','brands')->paginate(10);
return view('products.index',['data'=>$allProducts]);
    ...
    public function create(){
        ...
        $data=null;
        return view('Products.create_edit',compact('allCategories','allBrands','data'));
    ...
    public function edit($product){
        ...
        $allCategories=Product_Categories::where('status',1)->get();      //->pluck('product_category_name');
        return view('Products.create_edit',['data'=>$existing_prod,'allBrands'=>$allBrand,'allCategories'=>$allCategories]);
    }
